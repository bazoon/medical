Feature: Manage patient's index pages
    ...
    Scenario Outline: Visit index page, add a record and check if it saved 
        ...
        Given a user exists with name: "Petr", doctor_type: the doctor_type
        ...
        Examples:
            ...
            | name  | "01.01.2011" | "/clients/1/prof_inspections/" | prof_inspection_actual_date | prof_inspection_user_id | "Petr|surgeon" |
